 ...
 * The Stronghands developers 2011-2017
 */
    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("Stronghands") + " - " + tr("Wallet"));
...
#ifndef Q_OS_MAC
    QApplication::setWindowIcon(QIcon(":icons/stronghands"));
    setWindowIcon(QIcon(":icons/stronghands"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Stronghands address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/stronghands"), tr("&About Stronghands"), this);
    aboutAction->setStatusTip(tr("Show information about Stronghands"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Stronghands"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/stronghands"), tr("&Show / Hide"), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Stronghands addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Stronghands addresses"));

    openRPCConsoleAction = new QAction(QIcon(":/icons/debugwindow"), tr("&Debug window"), this);
    openRPCConsoleAction->setStatusTip(tr("Open debugging and diagnostic console"));

    openChatroomAction = new QAction(QIcon(":/icons/stronghands"), tr("&Chatroom"), this);
    openChatroomAction->setStatusTip(tr("Open https://stronghands.chat in a web browser."));

    openForumAction = new QAction(QIcon(":/icons/stronghands"), tr("&Forum"), this);
    openForumAction->setStatusTip(tr("Open https://talk.stronghands.net in a web browser."));
...
#ifndef Q_OS_MAC
            QApplication::setWindowIcon(QIcon(":icons/stronghands_testnet"));
            setWindowIcon(QIcon(":icons/stronghands_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/stronghands_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::openChatroom() {
    QDesktopServices::openUrl(QUrl("https://stronghands.chat"));
}

void BitcoinGUI::openForum() {
    QDesktopServices::openUrl(QUrl("https://talk.stronghands.net"));
}
...
{
    QString strTitle = tr("Stronghands"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Stronghands address or malformed URI parameters."),
