...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("stronghands-ext-ip");
...
void static StartSync(const vector<CNode*> &vNodes) {
    ...
    BOOST_FOREACH(CNode* pnode, vNodes) {
        ...
        if (!pnode->fClient && !pnode->fOneShot &&
            ...
            (pnode->nVersion < NOBLKS_VERSION_START || pnode->nVersion >= (GetAdjustedTime() > FORK_TIME ? NOBLKS_VERSION_END_FORK : NOBLKS_VERSION_END))) {
