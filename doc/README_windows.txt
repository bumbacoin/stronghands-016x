...
Setup
-----
After completing windows setup then run stronghands-qt.
Alternatively you can run windows command line (cmd) in stronghands program dir.
  cd daemon
  stronghandsd
You would need to create a configuration file stronghands.conf in the default
wallet directory. Grant access to stronghandsd/stronghands-qt in anti-virus and firewall
